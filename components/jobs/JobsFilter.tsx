    ...
    return (
        <div className='relative mt-11 flex w-full justify-between gap-5 max-sm:flex-col sm:items-center'>
            <LocalSearchbar
                ...
                placeholderText='Job Title, Company, or Keywords'
                additionalClasses='flex-1 max-sm:w-full'
            />
            ...
            <Select onValueChange={(value) => handleUpdateParams(value)}>
                ...
                <SelectContent className='text-dark500_light700 body-semibold max-h-[350px] max-w-[250px] bg-light-900 dark:border-dark-400 dark:bg-dark-300'>
                    <SelectGroup>
                        {countriesList ? (
                            countriesList.map((country: Country) => (
                                <SelectItem
                                    ...
                                    className='flex cursor-pointer px-4 py-3 focus:bg-light-800 dark:focus:bg-dark-400'
                                >
                                    {country.name.common}
                                </SelectItem>
                            ))
